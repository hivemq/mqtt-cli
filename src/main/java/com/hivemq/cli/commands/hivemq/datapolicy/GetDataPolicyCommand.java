...
import com.hivemq.cli.hivemq.datapolicy.GetDataPolicyTask;
...
public class GetDataPolicyCommand implements Callable<Integer> {
    ...
    public @NotNull Integer call() {
        ...
        final GetDataPolicyTask getDataPolicyTask =
                new GetDataPolicyTask(outputFormatter, dataPoliciesApi, policyId, fields);
        if (getDataPolicyTask.execute()) {
            return 0;
        } else {
            return 1;
        }
