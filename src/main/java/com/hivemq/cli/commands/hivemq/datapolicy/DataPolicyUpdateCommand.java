...
import com.hivemq.cli.hivemq.datapolicy.DataPolicyUpdateTask;
...
@CommandLine.Command(name = "update",
                     description = "Update an existing data policy",
...
public class DataPolicyUpdateCommand implements Callable<Integer> {
    ...
    @Inject
    public DataPolicyUpdateCommand(
    ...
    public @NotNull Integer call() {
        ...
        final DataPolicyUpdateTask dataPolicyUpdateTask =
                new DataPolicyUpdateTask(outputFormatter, dataPoliciesApi, gson, policyId, definition);
        if (dataPolicyUpdateTask.execute()) {
            return 0;
        } else {
            return 1;
        }
