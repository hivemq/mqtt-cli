...
import com.hivemq.cli.hivemq.datapolicy.CreateDataPolicyTask;
...
public class CreateDataPolicyCommand implements Callable<Integer> {
    ...
    @Inject
    public CreateDataPolicyCommand(
    ...
    public @NotNull Integer call() {
        ...
        final CreateDataPolicyTask createDataPolicyTask =
                new CreateDataPolicyTask(outputFormatter, dataPoliciesApi, gson, definition);
        if (createDataPolicyTask.execute()) {
            return 0;
        } else {
            return 1;
        }
