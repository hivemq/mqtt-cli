...
import com.hivemq.cli.hivemq.datapolicy.DeleteDataPolicyTask;
...
public class DeleteDataPolicyCommand implements Callable<Integer> {
    ...
    @Inject
    public DeleteDataPolicyCommand(
    ...
    public @NotNull Integer call() {
        ...
        final DeleteDataPolicyTask deleteDataPolicyTask =
                new DeleteDataPolicyTask(outputFormatter, dataPoliciesApi, policyId);
        if (deleteDataPolicyTask.execute()) {
            return 0;
        } else {
            return 1;
        }
