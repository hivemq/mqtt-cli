...
import com.hivemq.cli.hivemq.behaviorpolicy.ListBehaviorPoliciesTask;
...
public class ListBehaviorPoliciesCommand implements Callable<Integer> {
    ...
    @Inject
    public ListBehaviorPoliciesCommand(
    ...
    public @NotNull Integer call() {
        ...
        final ListBehaviorPoliciesTask listBehaviorPoliciesTask =
                new ListBehaviorPoliciesTask(outputFormatter, behaviorPoliciesApi, policyIds, clientIds, fields, limit);

        if (listBehaviorPoliciesTask.execute()) {
            return 0;
        } else {
            return 1;
        }
