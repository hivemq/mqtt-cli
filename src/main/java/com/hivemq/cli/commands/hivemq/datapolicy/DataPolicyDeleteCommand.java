...
import com.hivemq.cli.hivemq.datapolicy.DataPolicyDeleteTask;
...
@CommandLine.Command(name = "delete",
                     description = "Delete an existing data policy",
...
public class DataPolicyDeleteCommand implements Callable<Integer> {
    ...
    @Inject
    public DataPolicyDeleteCommand(
    ...
    public @NotNull Integer call() {
        ...
        final DataPolicyDeleteTask dataPolicyDeleteTask =
                new DataPolicyDeleteTask(outputFormatter, dataPoliciesApi, policyId);
        if (dataPolicyDeleteTask.execute()) {
            return 0;
        } else {
            return 1;
        }
    ...
    public @NotNull String toString() {
        return "DeleteDataPolicyCommand{" +
                "policyId='" +
                policyId +
                '\'' +
                ", dataHubOptions=" +
