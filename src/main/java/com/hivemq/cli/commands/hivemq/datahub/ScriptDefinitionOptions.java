...
public class ScriptDefinitionOptions {

    @SuppressWarnings("unused")
    @CommandLine.Option(names = {"--file"},
                        description = "The file containing the script definition. " +
    ...
    @CommandLine.Option(names = {"--definition"},
                        ...
                        description = "The script definition provided directly. " +
    ...
    public @NotNull String toString() {
        return "ScriptDefinitionOptions{" + "file=" + file + ", definition=" + argument + '}';
    }
}
