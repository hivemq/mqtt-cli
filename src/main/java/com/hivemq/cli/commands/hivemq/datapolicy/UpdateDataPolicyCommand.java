...
import com.hivemq.cli.hivemq.datapolicy.UpdateDataPolicyTask;
...
public class UpdateDataPolicyCommand implements Callable<Integer> {
    ...
    @Inject
    public UpdateDataPolicyCommand(
    ...
    public @NotNull Integer call() {
        ...
        final UpdateDataPolicyTask updateDataPolicyTask =
                new UpdateDataPolicyTask(outputFormatter, dataPoliciesApi, gson, policyId, definition);
        if (updateDataPolicyTask.execute()) {
            return 0;
        } else {
            return 1;
        }
