...
import com.hivemq.cli.hivemq.datapolicy.ListDataPoliciesTask;
...
@CommandLine.Command(name = "list", description = "List all existing data policies", mixinStandardHelpOptions = true)
public class ListDataPoliciesCommand implements Callable<Integer> {
    ...
    @Inject
    public ListDataPoliciesCommand(
    ...
    public @NotNull Integer call() {
        ...
        final ListDataPoliciesTask listDataPoliciesTask =
                new ListDataPoliciesTask(outputFormatter, dataPoliciesApi, topic, policyIds, schemaIds, fields, limit);

        if (listDataPoliciesTask.execute()) {
            return 0;
        } else {
            return 1;
        }
