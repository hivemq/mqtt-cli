...
import com.hivemq.cli.hivemq.behaviorpolicy.BehaviorPolicyDeleteTask;
...
public class BehaviorPolicyDeleteCommand implements Callable<Integer> {
    ...
    @Inject
    public BehaviorPolicyDeleteCommand(
    ...
    public @NotNull Integer call() {
        ...
        final BehaviorPolicyDeleteTask behaviorPolicyDeleteTask =
                new BehaviorPolicyDeleteTask(outputFormatter, behaviorPoliciesApi, policyId);
        if (behaviorPolicyDeleteTask.execute()) {
            return 0;
        } else {
            return 1;
        }
