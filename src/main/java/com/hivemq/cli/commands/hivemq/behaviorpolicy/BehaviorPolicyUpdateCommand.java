...
import com.hivemq.cli.hivemq.behaviorpolicy.BehaviorPolicyUpdateTask;
...
public class BehaviorPolicyUpdateCommand implements Callable<Integer> {
    ...
    @Inject
    public BehaviorPolicyUpdateCommand(
    ...
    public @NotNull Integer call() {
        ...
        final BehaviorPolicyUpdateTask behaviorPolicyUpdateTask =
                new BehaviorPolicyUpdateTask(outputFormatter, behaviorPoliciesApi, gson, policyId, definition);
        if (behaviorPolicyUpdateTask.execute()) {
            return 0;
        } else {
            return 1;
        }
    ...
    public @NotNull String toString() {
        return "UpdateBehaviorPolicyCommand{" +
                "policyId='" +
                policyId +
                '\'' +
                ", definitionOptions=" +
