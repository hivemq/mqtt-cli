...
import com.hivemq.cli.hivemq.behaviorpolicy.BehaviorPolicyGetTask;
...
public class BehaviorPolicyGetCommand implements Callable<Integer> {
    ...
    @Inject
    public BehaviorPolicyGetCommand(
    ...
    public @NotNull Integer call() {
        ...
        final BehaviorPolicyGetTask behaviorPolicyGetTask =
                new BehaviorPolicyGetTask(outputFormatter, behaviorPoliciesApi, policyId, fields);
        if (behaviorPolicyGetTask.execute()) {
            return 0;
        } else {
            return 1;
        }
