...
import com.hivemq.cli.hivemq.behaviorpolicy.CreateBehaviorPolicyTask;
...
public class CreateBehaviorPolicyCommand implements Callable<Integer> {
    ...
    @Inject
    public CreateBehaviorPolicyCommand(
    ...
    public @NotNull Integer call() {
        ...
        final CreateBehaviorPolicyTask createBehaviorPolicyTask =
                new CreateBehaviorPolicyTask(outputFormatter, behaviorPoliciesApi, gson, definition);
        if (createBehaviorPolicyTask.execute()) {
            return 0;
        } else {
            return 1;
        }
