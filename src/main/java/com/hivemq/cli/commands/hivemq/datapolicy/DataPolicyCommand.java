...
@CommandLine.Command(name = "data-policy",
                     description = "Operations for data policies in a HiveMQ broker",
...
public class DataPolicyCommand implements Callable<Integer> {
