...
import com.hivemq.cli.hivemq.datapolicy.DataPolicyCreateTask;
...
public class DataPolicyCreateCommand implements Callable<Integer> {
    ...
    @Inject
    public DataPolicyCreateCommand(
    ...
    public @NotNull Integer call() {
        ...
        final DataPolicyCreateTask dataPolicyCreateTask =
                new DataPolicyCreateTask(outputFormatter, dataPoliciesApi, gson, definition);
        if (dataPolicyCreateTask.execute()) {
            return 0;
        } else {
            return 1;
        }
