...
public class GetSchemaCommandTest {
    ...
    private final @NotNull CommandLine commandLine =
            new CommandLine(new GetSchemaCommand(hiveMQRestService, outputFormatter));
    ...
    void call_taskFailed_return1() throws ApiException {
        when(schemasApi.getSchema(any(), isNull())).thenThrow(ApiException.class);
