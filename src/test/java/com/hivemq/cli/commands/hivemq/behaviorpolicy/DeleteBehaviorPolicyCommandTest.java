...
public class DeleteBehaviorPolicyCommandTest {
    ...
    private final @NotNull CommandLine commandLine =
            new CommandLine(new DeleteBehaviorPolicyCommand(hiveMQRestService, outputFormatter));
    ...
    void call_taskSuccessful_return0() throws ApiException {
        ...
        verify(behaviorPoliciesApi).deleteBehaviorPolicy(eq("policy-1"));
    }
