...
class DirectoryToCertificatesConverterTest {
    ...
    private @NotNull DirectoryToCertificatesConverter directoryToCertificatesConverter;
    private @NotNull String pathToValidDirectory;
    ...
    void setUp() throws URISyntaxException {
        ...
        final URL noCertificatesDir =
                getClass().getResource("/FileToCertificateConverter/directory_without_certificates");
    ...
    void convert_Success() throws Exception {
        final Collection<X509Certificate> certificates = directoryToCertificatesConverter.convert(pathToValidDirectory);
    ...
    void convert_Failure_DirectoryNotFound() {
        final Exception e = assertThrows(FileNotFoundException.class,
                () -> directoryToCertificatesConverter.convert("invalidPath"));
    ...
    void convert_Failure_DirectoryIsAFile() {
        final Exception e =
                assertThrows(Exception.class, () -> directoryToCertificatesConverter.convert(pathToValidCertificate));
    ...
    void convert_Failure_DirectoryWithoutCertificates() {
        final Exception e = assertThrows(Exception.class,
                () -> directoryToCertificatesConverter.convert(pathToDirectoryWithoutCertificates));
