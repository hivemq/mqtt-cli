...
| -wpr | --willProperties |Will properties, can contain one or more header:value pairs| default empty
| -wd  | --willDelay |Will delay interval in seconds | 0
...
| -wp  | --willPayload |Payload of the Will message can be defined direct or
