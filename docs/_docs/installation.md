...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.35.0/mqtt-cli-4.35.0-win.zip) and
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.35.0/mqtt-cli-4.35.0.rpm
```
