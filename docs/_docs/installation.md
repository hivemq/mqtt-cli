...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.40.2/mqtt-cli-4.40.2-win.zip) and
...
```
wget https://github.com/hivemq/mqtt-cli/releases/download/v4.40.2/mqtt-cli-4.40.2.deb
sudo apt install ./mqtt-cli-4.40.2.deb
```
...
```
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.40.2/mqtt-cli-4.40.2.rpm
```
