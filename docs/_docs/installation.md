...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.51.0/mqtt-cli-4.51.0-win.zip) and
...
``` 
wget https://github.com/hivemq/mqtt-cli/releases/download/v4.51.0/mqtt-cli-4.51.0.deb
sudo apt install ./mqtt-cli-4.51.0.deb
``` 
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.51.0/mqtt-cli-4.51.0.rpm
```
