...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.47.0/mqtt-cli-4.47.0-win.zip) and
...
sudo apt install ./mqtt-cli-4.47.0.deb
``` 
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.47.0/mqtt-cli-4.47.0.rpm
```
