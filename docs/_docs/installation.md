...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.14.0/mqtt-cli-4.14.0-win.zip) and
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.14.0/mqtt-cli-4.14.0.rpm
```
