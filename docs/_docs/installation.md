...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.34.0/mqtt-cli-4.34.0-win.zip) and
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.34.0/mqtt-cli-4.34.0.rpm
```
