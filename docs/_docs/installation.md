...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.52.0/mqtt-cli-4.52.0-win.zip) and
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.52.0/mqtt-cli-4.52.0.rpm
```
