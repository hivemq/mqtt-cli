...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.7.2/mqtt-cli-4.7.2-win.zip) and extract it in your preferred location.
...
``` 
wget https://github.com/hivemq/mqtt-cli/releases/download/v4.7.2/mqtt-cli-4.7.2.deb
sudo apt install ./mqtt-cli-4.7.2.deb
``` 
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.7.2/mqtt-cli-4.7.2.rpm
```
