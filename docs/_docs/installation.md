...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.28.1/mqtt-cli-4.28.1-win.zip) and
...
``` 
wget https://github.com/hivemq/mqtt-cli/releases/download/v4.28.1/mqtt-cli-4.28.1.deb
sudo apt install ./mqtt-cli-4.28.1.deb
``` 
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.28.1/mqtt-cli-4.28.1.rpm
```
