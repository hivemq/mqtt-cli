...
Download the [Windows Zipfile](https://github.com/hivemq/mqtt-cli/releases/download/v4.30.0/mqtt-cli-4.30.0-win.zip) and
...
``` 
sudo yum install -y https://github.com/hivemq/mqtt-cli/releases/download/v4.30.0/mqtt-cli-4.30.0.rpm
```
